...
class _AvailabilityManagementScreenState extends State<AvailabilityManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _buildBottomNav(theme, 1),
    );
  }
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _buildNavItem(Icons.videocam, 'My Sessions', currentIndex == 0, theme),
              _buildNavItem(Icons.calendar_month, 'Availability', currentIndex == 1, theme),
